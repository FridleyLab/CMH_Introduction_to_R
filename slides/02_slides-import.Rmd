...
subtitle: "Data importing and cleaning"
author: 
...
The TARGET study aimed to examine molecular drivers of the development and progression of hard-to-treat
childhood cancers. 

  * ALL - Acute Lymphoblastic Leukemia
  * P2 - Phase II, the phase of the study when tumors from pediatric cases who 
  experienced bone marrow relapse within 4 years of diagnosis 
  
Data is saved as multiple `.csv`s : `data/TARGET_P2_clinical.csv`, `data/TARGET_P2_follow_up.csv` and `data/TARGET_P2_tpm.csv`
